  ...
  const handlePayment = async () => {
    ...
    try {
      const hiringRequest: CreateHiringRequest = {
        ...
        day: cartService.selectedDay,
        time: cartService.selectedTime,
        payment: {
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              >
                {isProcessingPayment ? "Procesando..." : "Contratar Servicio"}
              </Button>
            </CardContent>
          </Card>
        </div>
            ...
            <CardContent className="p-6">
              ...
              <div className="mt-3 pt-4 border-t">
                ...
                <p className="text-sm text-muted-foreground">
                  <span className="font-medium">{cartService.selectedDay}</span>{" "}
                  a las{" "}
              ...
              <div className="mt-4">
                ...
                <div className="text-sm text-muted-foreground space-y-1">
                  ...
                  <p>
                    ...
                    {cartService.mode === "online" ? "Virtual" : "Presencial"}
                  </p>
                  <p>
