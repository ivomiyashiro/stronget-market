...
import { useTrainerLoading, useTrainerStatistics } from "@/store/trainer/trainer.hooks";
...
const Profile = () => {
    ...
    const { profile: profileUser, isLoading, error, fetchUserProfile } = useProfile();
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-row gap-2 items-center text-muted-foreground">
                            ...
                            {profileUser?.birthDay &&
                                formatBirthDay(profileUser.birthDay)}
                        </div>
                    </div>
                </div>
                                    ...
                                    <Card className="w-full">
                                        ...
                                        <CardContent>
                                            <div className="flex flex-row items-center justify-between gap-2">
                                                ...
                                                <p className="text-muted-foreground mt-1">
                                                    {trainerStatistics.performance?.toFixed(
                                                        1
                                                    ) || 0}
                                                    %
                                                </p>
